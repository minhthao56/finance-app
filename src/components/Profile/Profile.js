...
export default function Profile(props) {
  ...
  return (
    ...
    >
      ...
      <h2
        id="dark-title"
        style={{ marginLeft: 70, marginTop: 10, marginBottom: 15 }}
      >
        Your Account
      </h2>
          ...
          <div className="container-card-wallet">
            <div className="card-wallet">
              ...
              <div className="money-wallet">
                ...
                <span style={{ marginLeft: "auto" }}>{Balance[0]}$</span>
              </div>
              <div className="money-wallet">
                <div>
                ...
                <span style={{ marginLeft: "auto" }}>{Balance[1]}$</span>
              </div>
            </div>
          </div>
          <div>
              ...
              {dataIcome.map((data) => {
                return (
                  <div className="container-history-income">
                    ...
                    <span style={{ marginLeft: "auto" }}>{data.amount}$</span>
                  </div>
                );
              })}
            </div>
